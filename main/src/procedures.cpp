...
void deployBridge(){
    ...
    mvt.move(1,1,5,5,110);
    motor.shut_down();

    //go backwards across the bridge
    mvt.move(-1,-1,52,52,80);
    delay(500);
    mvt.move(-1,-1,2,10,80);
    delay(500);
}
...
void handleFourthEwok() {
    ...
    bool foundEwok = lookForEwok(Constants::distantInfraredThreshold4, 15, -1);
